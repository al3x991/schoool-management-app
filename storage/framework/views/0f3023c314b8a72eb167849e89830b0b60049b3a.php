    ...
    <div class="container white-shadow">
        ...
        <div class="row">
          <form action="/teacher/user/updatePic" id="uploadimage" enctype="multipart/form-data" method="POST">
            ...
            <img src="/img/user-profile-img/<?php echo e($image); ?>" class="img" alt="" /><label id="#bb"><a class="detail-edit" title="edit"><i class="fas fa-edit" style="color: #fff;"></i></a>

<input type="file" name="image" class="File" id="File"  size="60" style="display: none;" >
</label>
</div>
</form>
            <div class="detail-status"><span><?php echo e(\App\Http\Controllers\DashboardController::sec_ago()); ?></span></div>
        </div>

        <div class="row bottom-mrg">
            <div class="col-md-12 col-sm-12">
                <div class="advance-detail detail-desc-caption">
                    <h4><?php echo e($name); ?></h4><span class="designation"></span>
                    <ul>
    ...
    <div class="container">
      ...
      <div class="tab-content">
        ...
        <div id="courses" class="tab-pane fade show active p-3">
          ...
          <p>
              <div class="row">
          <?php if(count($cEnrolled) > 0): ?>
<?php $__currentLoopData = $cEnrolled; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrolled): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
...
?>
		...
		<div class="course-details">
			<span class="course-catagory"><?php echo e($cat); ?></span>
			<h4><a href=""><?php echo e(mb_strimwidth($title, 0, 35, "...")); ?></a></h4>
			<p><?php echo e(mb_strimwidth($desc, 0, 80, "&nbsp;...")); ?></p>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\schoolapp\resources\views//user/dashboard.blade.php ENDPATH**/ ?>